                                ...
                                <div class="pdt-contact-btn">
                                    ...
                                    <span class="display-5">
                                        <a href="mailto:{{ $organisation->email }}"
                                            class="btn btn-outline-theme d-inline-block radius-5">
                                    ...
                                    <div class="card-body p-0">
                                        <div id="comments">
                                            @foreach ($organisation->root_comments as $comment)
                                                @include('organisations.components.comment', [
                                                    'comment' => $comment,
                                                ])
                                            @endforeach
                                        </div>
                                    ...
                                    <div id="accordion" class="accordion">
                                        <div class="card mb-0 border-0">
                                            ...
                                            <div class="card-header border-theme bg-white mt-3 mb-0">
                                                <a href="#collapseTwo" class="card-title collapsed d-block mb-0"
                                                    data-toggle="collapse">
                                            ...
                                            <div class="card-header card-header border-theme bg-white mt-3 mb-0">
                                                <a href="#collapseThree" class="card-title collapsed d-block mb-0"
                                                    data-toggle="collapse">
                            ...
                            <div class="card-image">
                                ...
                                <div class="image-overlay">
                                    <a href="single-product.html"
                                        class="btn btn-outline-white radius-5 py-3 px-4  text-capitalize">More Info</a>
                                </div>
                            </div>
                            <div class="card-body p-3">
                                <h4 class="card-title mb-0"><a href="single-product.html" class="text-link">Pet
                                        Boarding</a></h4>
                                <div class="card-text">
                                            ...
                                            <div class="col-6">
                                                <div class="media align-items-center">
                                                    <a href="user-profile.html" class="text-link d-inline-block">
                                                        <img src="assets/img/owner-avatar-img.jpg" alt="John Doe"
                                                            class="mr-3 img-fluid rounded-circle d-inline-block">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="pdt-add-to-cart text-center">
                                                    <a class="btn-outline-theme d-block radius-5 px-3 py-2"
                                                        href="cart-page.html">
